...
export const DRAMA_EVENTS: InteractiveGameEvent[] = [
  // ===== 高光事件 =====
  {
    ...
    name: "🌟 单品爆单",
    description: (s) =>
      `这周营收破了 ¥${Math.round(s.weeklyRevenue ?? 0).toLocaleString()}！有食客把照片发到了网上，评论区开始有人@你的店。`,
    category: "random",
  ...
  },
  {
    ...
    name: "📺 美食博主探店",
    description:
      "一个本地美食博主突然来探店，说店里干净又有味道，准备拍条视频。",
    category: "operation",
    triggerCondition: { phase: "operating", probability: 0 },
    options: [
      {
  ...
  },
  {
    ...
    name: "🤝 加盟邀请",
    description:
      "一家区域品牌看上你的口碑，发来加盟邀请——挂他们的牌子，他们出供货和营销，你出店面和管理。",
    category: "franchise",
    triggerCondition: { phase: "operating", probability: 0 },
    options: [
      {
  ...
  },
  {
    ...
    name: "🥇 平台 TOP3",
    description:
      '外卖平台运营找上门：你的店挤进了片区前三，可以申请"金标商家"。',
    category: "operation",
    triggerCondition: { phase: "operating", probability: 0 },
    options: [
      {
  ...
  },
  {
    ...
    name: "🏆 行业奖项",
    description:
      '当地行业协会发来通知，你被提名为"年度优质小店"。颁奖晚会上需要你出席并发言。',
    category: "mindset",
    triggerCondition: { phase: "operating", probability: 0 },
    options: [
      {
          ...
          delayedEffects: [
            {
              delayWeeks: 1,
              effects: { cash: 25000 },
              description: "投资人最终接受了 ¥25k 占 25% 的方案",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    name: "🎙️ 媒体翻案",
    description:
      '前段时间的食安/卫生告警让你口碑下滑，一个本地公众号愿意做一期"小店改造"专题，给你正名。',
    category: "random",
    triggerCondition: { phase: "operating", probability: 0 },
    options: [
      {
  ...
  },
  {
    ...
    name: "👥 社区众筹",
    description:
      '常客们听说你最近不容易，私下组了个群，说要发起"先付费，后消费"的会员卡，帮你撑过来。',
    category: "mindset",
    triggerCondition: { phase: "operating", probability: 0 },
    options: [
      {
        ...
        effects: {
          ...
          delayedEffects: [
            {
              delayWeeks: 4,
              effects: { cash: -800, reputation: 3 },
              description: "陆续兑现会员卡消费，但口碑回升",
            },
          ],
        },
      },
