...
export const MONTHLY_MARKETING_COST = 400; // 月营销费用（Phase 6: 800→400，小店基础宣传 ¥400 足够）
...
export const SEASON_MODIFIER = {
  spring: 0.9, // 春季淡季（返工/返校过渡期，但不至于太惨）
  ...
  },
  {
    ...
    addresses: [
      ...
      },
      {
        ...
        trafficModifier: 1.1,
        rentModifier: 1.2,
        description: "步行街一楼，人流量大",
      },
      {
        id: "business_corner",
        name: "街角转角铺",
        area: 70,
        trafficModifier: 0.85,
        rentModifier: 0.9,
        description: "位置稍偏但面积大",
      },
    ],
  },
  {
    ...
    addresses: [
      ...
      },
      {
        ...
        trafficModifier: 1.2,
        rentModifier: 1.3,
        description: "景区内部，客单价高",
      },
      {
        id: "tourist_parking",
        name: "停车场旁",
        area: 65,
        trafficModifier: 0.75,
        rentModifier: 0.7,
        description: "面积大租金低，自驾游客群",
      },
    ],
  },
];
...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    trafficMultiplier: 1.4, // Round 4: 从1.65回调，品牌流量优势不应过大
    conversionBonus: 0,
  ...
  },
  {
    ...
    trafficMultiplier: 1.3, // Round 4: 从1.50回调
    conversionBonus: 0,
  ...
  },
  {
    ...
    trafficMultiplier: 1.5, // Round 4: 从1.80回调
    conversionBonus: 0,
...
export const yongGeAdvices: YongGeAdvice[] = [
  {
    ...
    title: "快招警告",
    content:
      "哥们，这品牌我都没听说过，总部在哪？济南？就一样板间是吧？快招公司！赶紧退钱！",
  ...
  },
  {
    ...
    title: "选址建议",
    content:
      "来，360度转一圈。这地方根本没人流啊！楼上写字楼就是客源？人家下班直接回家了！",
  ...
  },
  {
    ...
    title: "成本控制",
    content:
      "一天卖800块，你请7个人？现在就给我去把那4个员工开了！人工比营业额还高，你在做慈善吗？",
  ...
  },
  {
    ...
    title: "单品警告",
    content:
      "周围没人卖生蚝就是商机？那是没人买！你卖车找达人宣传还被骗2000，赶紧关了吧！",
  ...
  },
  {
    ...
    title: "加盟提醒",
    content:
      '你想加盟蜜雪，结果打到快招公司去了？他们说这是"第四代汉堡"？哥们，塔斯汀高管出来单干？骗鬼呢！',
  ...
  },
  {
    ...
    title: "财务健康",
    content:
      "毛利率连20%都不到？总部原料比市场价高1-2倍，你这根本覆盖不了成本啊！",
  ...
  },
  {
    ...
    title: "竞争提醒",
    content:
      "你凭什么觉得能干得过旁边的蜜雪？人家上市公司全球4万家店，你觉得不怎么样？",
  ...
  },
  {
    ...
    title: "止损建议",
    content:
      "这店没救了，今天就去把员工开了，该起诉起诉，让总部把加盟费退回来。",
